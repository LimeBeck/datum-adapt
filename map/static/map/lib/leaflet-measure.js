!function (e) {
    ...
    e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Измерение расстояния и площади">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Измерение расстояния и площади</h3> <ul class=tasks> <a href=# class="js-start start">Новое измерение</a> </ul> </div> <div class=js-measuringprompt> <h3>Измерение расстояния и площади</h3> <p class=js-starthelp>Начните измерение с создания точек на карте</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Отмена</a></li> <li><a href=# class="js-finish finish">Закончить измерение</a></li> </ul> </div> </div> '
}, function (e, t, r) {
    e.exports = '<div class=group> <p class="lastpoint heading">Последняя точка</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Расстояние</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Площадь</span> {{ model.areaDisplay }}</p> </div> <% } %> '
}, function (e, t, r) {
    e.exports = '<h3>Местоположение точки</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Центрировать на измерении</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h3>Измерение расстояния</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Центрировать на линии</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Удалить</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h3>Измерение площади</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Периметр</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Центрировать на площади</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Удалить</a></li> </ul> '
}]);